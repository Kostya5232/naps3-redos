...
Текущая версия исходного кода — **0.8.2** для **РЕД ОС 8 x86_64** и **Windows 10/11 x64**.
...
Теги вида `v0.8.2` запускают GitHub Actions: тесты, сборку RPM, сборку Windows EXE
